...
package org.bathtubchickens.frc2025.util.swerve;

import static org.bathtubchickens.frc2025.util.EqualsUtil.*;
...
import org.bathtubchickens.frc2025.util.EqualsUtil;
...
public class SwerveSetpointGenerator {
  ...
  public SwerveSetpoint generateSetpoint(
    ...
    SwerveModuleState[] desiredModuleState =
        kinematics.toSwerveModuleStates(desiredState, centerOfRotation);
    ...
    for (int i = 0; i < modules.length; i++) {
      if (Math.hypot(desired_vx[i], desired_vy[i]) > Math.hypot(prev_vx[i], prev_vy[i])) {
        // One module is accelerating, enforce acceleration limits, if one module is accelerating,
